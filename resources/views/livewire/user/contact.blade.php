 ...
 <section id="ContactUs">
    ...
    <div class="section_1">
        <div class="titleContainer w-100 d-flex justify-content-center align-items-center">
            <img class="imgTitle w-100" src="./copu.png">
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-4 mt-5">
                <div class="DetailsContainer">
                    ...
                    <div class="quotesDetail m-3">Write to this email for a detailed quotation <span>quote@travel.com</span> and information.</div>
                    <div class="consulting m-3">Consulting</div>
                    <div class="consultingDetail m-3">Our free consultation service can be requested here <span>info@travel.com</span> every day.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section_3">
        <div class="formContactUsContainer container-xl">
            ...
            <div class="note text-center mt-3">We value your feedback and would love to hear your thoughts and suggestions. Please take a moment to provide your feedback so we can continually improve our services and offer you the best travel experiences.</div>
            <div class="formContactUs pt-5">
                ...
                <div class="form-group mt-4 i2">
                    <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="Insert your email">
                </div>
    ...
    <div class="section_4">
        <iframe class="mapGoogle w-100 h-100" src="https://maps.google.com/maps?ll=21.037811,105.809581&q=285 Đội Cấn&t=&z=14&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
    </div>
</section>
@endsection
