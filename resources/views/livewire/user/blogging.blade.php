                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="d-flex flex-row justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-danger d-flex align-items-center justify-content-center" wire:click="removeSection({{ $index }})">
                            ...
                            <!-- Section Title -->
                            <div class="mb-3">
                                <label for="sections.{{ $index }}.title" class="form-label fw-bold">Section Title</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-2">
                                    <input type="file" wire:model="sections.{{ $index }}.images.{{ $imageIndex }}"
                                        class="form-control">
                                    <button type="button" class="btn btn-danger d-flex align-items-center justify-content-center" wire:click="removeImage({{ $index }}, {{ $imageIndex }})">
                                        <span class="material-symbols-outlined text-light">
                                            delete
                                        </span>
                                    </button>
                                ...
                                @endforeach
                                @endif
                                <button type="button" class="btn btn-secondary w-100" wire:click="addImage({{ $index }})">Add Image</button>
                            </div>
                        </div>
                    </div>
                    @endforeach
